...
|---------|-------------|-------|
| `~/.claude` | Current working directory | Cyan |
...
| `CTX 90.0%` | Context window remaining | Label: Dim, Value: Bold + Color |
...
- **Session info** (model, cwd, cost, context): Received via stdin JSON from Claude Code
